  ...
  "zh-CN": {
    translation: {
      ...
      console: {
        ...
        quickImportDescription: "支持纯 SSO Token，或邮箱----密码----SSO Token 格式；可粘贴多行或上传 TXT，重复项会自动忽略。",
      ...
      accounts: {
        ...
        uploadTXT: "上传 TXT",
        ssoTokenPlaceholder: "sso_token_1\nsso=token_2\nemail@example.com----password----sso_token_3",
        importAction: "开始导入",
        exportAuth: "导出账号文件",
        exported: "账号凭据已导出",
  ...
  en: {
    translation: {
      ...
      console: {
        ...
        quickImportDescription: "Paste plain SSO tokens or email----password----SSO token records. Multiple lines and TXT uploads are supported; duplicates are ignored.",
        accountBreakdown: "Build {{build}} · Web {{web}} · Console {{console}}",
...
Object.assign(resources["zh-CN"].translation.updates, {
  latestVersionHelp: "最近一次从已配置 GitHub 仓库的 Releases 获取的最新版本。",
  checkedAtHelp: "最近一次成功获取该仓库发布信息的时间。",
  releaseNotesHelp: "该 GitHub Release 提供的版本变更摘要。",
  repository: "GitHub 更新仓库",
  repositoryHelp: "更新来源，仅支持公开 GitHub 仓库。接受 owner/repository 或完整仓库地址；留空保存可停用。",
  repositorySaved: "更新仓库已保存",
  repositoryUnsaved: "仓库地址尚未保存。",
  repositoryMissing: "尚未配置更新仓库。",
  install: "安装更新",
  retryInstall: "重试安装",
  confirmInstall: "确认并更新",
  manageUpdate: "前往更新",
  viewProgress: "查看更新状态",
  confirmTitle: "安装 {{version}}？",
  confirmDescription: "更新来源：{{repository}}。仅安装你信任的仓库发布的程序。\n\n更新会重启服务，期间请求可能中断，请选择业务空闲时操作。\n\n启动失败时会尝试回退应用文件。数据库和持久化数据不在自动回退范围内，更新前请确认已有数据备份。",
  installRequestFailed: "未能确认安装请求结果，正在同步服务端任务状态。重试前请确认没有正在执行的更新。",
  reconnecting: "正在重新连接服务",
  statusUnavailable: "暂时无法获取更新状态",
  reconnectHelp: "连接恢复后会继续获取任务进度。",
  targetVersion: "目标版本 {{version}}",
  progressUpdatedAt: "状态更新时间：{{time}}",
  rollbackHelp: "已回退应用文件，数据库和持久化数据未回退。请检查失败原因和数据状态后再重试。",
  job: {
    idle: "暂无更新任务",
    downloading: "正在下载更新",
    verifying: "正在校验安装包",
    extracting: "正在准备新版本",
    restarting: "正在重启服务",
    succeeded: "已更新至 {{version}}",
    failed: "更新失败",
    rolled_back: "更新失败，已回退应用文件",
  },
  stage: { downloading: "下载", verifying: "校验", extracting: "准备", restarting: "重启", succeeded: "完成" },
});
Object.assign(resources.en.translation.updates, {
  latestVersionHelp: "Latest release retrieved from the configured GitHub repository.",
  checkedAtHelp: "Most recent successful retrieval of release information from this repository.",
  releaseNotesHelp: "Version summary published with this GitHub Release.",
  repository: "GitHub update repository",
  repositoryHelp: "Public GitHub repositories only. Accepts owner/repository or a full repository URL. Save an empty value to disable.",
  repositorySaved: "Update repository saved",
  repositoryUnsaved: "Repository changes have not been saved.",
  repositoryMissing: "No update repository configured.",
  install: "Install update",
  retryInstall: "Retry installation",
  confirmInstall: "Confirm and update",
  manageUpdate: "Manage update",
  viewProgress: "View update status",
  confirmTitle: "Install {{version}}?",
  confirmDescription: "Update source: {{repository}}. Install releases only from a repository you trust.\n\nUpdating restarts the service and may interrupt requests. Choose a quiet period.\n\nIf startup fails, the updater will attempt to restore the previous application files. Database and persistent data changes are not rolled back. Confirm you have a data backup before proceeding.",
  installRequestFailed: "The installation request could not be confirmed. Synchronizing the server job status; check that no update is running before retrying.",
  reconnecting: "Reconnecting to the service",
  statusUnavailable: "Update status is temporarily unavailable",
  reconnectHelp: "Progress checks will continue when the connection recovers.",
  targetVersion: "Target version {{version}}",
  progressUpdatedAt: "Status updated {{time}}",
  rollbackHelp: "Application files were restored. Database and persistent data were not rolled back. Check the failure and data state before retrying.",
  job: {
    idle: "No update in progress",
    downloading: "Downloading update",
    verifying: "Verifying package",
    extracting: "Preparing new version",
    restarting: "Restarting service",
    succeeded: "Updated to {{version}}",
    failed: "Update failed",
    rolled_back: "Update failed; application files restored",
  },
  stage: { downloading: "Download", verifying: "Verify", extracting: "Prepare", restarting: "Restart", succeeded: "Complete" },
});
