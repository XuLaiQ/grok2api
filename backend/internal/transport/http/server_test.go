...
func TestSystemEndpointsRequireAdminAuthentication(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{method: http.MethodPut, path: "/api/admin/v1/system/update/config"},
		{method: http.MethodGet, path: "/api/admin/v1/system/update/status"},
		{method: http.MethodPost, path: "/api/admin/v1/system/update/install"},
	} {
