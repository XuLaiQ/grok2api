...
func Run(args []string) error {
	...
	if options.supervise {
		...
		return updateruntime.Run(ctx, updateruntime.Options{
			Root: cfg.Updates.Directory, Executable: executable,
			ConfigPath: options.configPath, Listen: cfg.Server.Listen, Logger: logger,
		})
	}
